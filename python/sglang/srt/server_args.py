    ...
    def init_new(
        ...
        if not server_args.enable_dp_attention:
            ...
            return PortArgs(
                ...
                sdp_controller_ipc_name=f"ipc://{tempfile.NamedTemporaryFile(delete=False).name}",
            ...
            return PortArgs(
                ...
                dp_controller_ipc_name=f"tcp://{dist_init_host}:{scheduler_input_port}",
